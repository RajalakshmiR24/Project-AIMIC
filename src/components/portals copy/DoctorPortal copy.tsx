...
const PatientManagement: React.FC = () => {
  ...
  const [editPatient, setEditPatient] = useState<Patient>({} as Patient);
  ...
  const getPid = (r: any): string | undefined => {
    ...
    const pid =
      typeof r.patientId === "object" && r.patientId !== null
  ...
  const reportDetailsHTML = (r: any) => {
    ...
    return `
      <div style="text-align:left; line-height:1.55">
        <div style="font-weight:800; font-size:18px; margin-bottom:6px">${display(
          r.reportType
        )}</div>
        <div style="color:#475569; font-size:13px; margin-bottom:12px">
          <b>Report ID:</b> ${display(r._id)} &nbsp; • &nbsp;
        ...
        <div style="margin-bottom:10px">
          <div style="font-weight:700; margin-bottom:6px">Clinical Details</div>
          <div><b>Primary Diagnosis:</b> ${display(r.primaryDiagnosis)}</div>
          <div><b>Treatment Provided:</b><pre style="white-space:pre-wrap;margin:6px 0 0">${display(
            r.treatmentProvided
          )}</pre></div>
          <div><b>Medications Prescribed:</b> ${display(
        ...
        <div style="margin-bottom:10px">
          <div style="font-weight:700; margin-bottom:6px">Follow-up</div>
          <div><b>Follow-up Date:</b> ${
            r?.followUpDate ? fmt(r.followUpDate) : "—"
          }</div>
          <div><b>Recommendations:</b> ${display(r.recommendations)}</div>
        </div>
        <div>
    ...
    const rowsHTML = ptReports
      .map((r) => {
        ...
        <tr>
          ...
          <td class="px-3 py-2"><span style="font-size:12px;padding:2px 8px;border-radius:9999px;${badge}">${display(
            r.status || "submitted"
          )}</span></td>
  ...
  const handleUpdatePatient = async (e: React.FormEvent) => {
    ...
    const payload: Partial<Patient> = {
      fullName: editPatient.fullName?.trim(),
      age: editPatient.age,
      phone: editPatient.phone,
      email: editPatient.email,
      primaryCondition: editPatient.primaryCondition,
      insurancePlanName: editPatient.insurancePlanName,
      ...
      sex: editPatient.sex,
      nextAppointment: editPatient.nextAppointment,
      lastVisit: editPatient.lastVisit,
    };

    await updatePatient(editPatient._id, payload);
  ...
  const handleAddPatient = async (e: React.FormEvent) => {
    ...
    const payload: Partial<Patient> = {
      ...
      insurancePlanName:
        String(newPatient.insurancePlanName || "").trim() || undefined,
      primaryCondition:
        String(newPatient.primaryCondition || "").trim() || undefined,
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
    <div className="bg-white rounded-2xl w-full max-w-6xl shadow-xl overflow-hidden">
      ...
      <form
        ...
        className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-8 max-h-[80vh] overflow-y-auto"
      >
        {/* LEFT SIDE */}
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, fullName: e.target.value })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, age: Number(e.target.value) })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, birthDate: e.target.value })
              }
            />
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, addressLine1: e.target.value })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, addressLine2: e.target.value })
              }
            />
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <input
              ...
              onChange={(e) =>
                setEditPatient({ ...editPatient, zipCode: e.target.value })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              className="w-full p-3 border rounded-lg"
              value={editPatient.insuranceId || ""}
              onChange={(e) =>
                setEditPatient({ ...editPatient, insuranceId: e.target.value })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              className="w-full p-3 border rounded-lg"
              value={editPatient.primaryCondition || ""}
              onChange={(e) =>
                setEditPatient({
                  ...editPatient,
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditPatient({ ...editPatient, lastVisit: e.target.value })
                }
              />
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full">
            ...
            <form onSubmit={handleAddPatient} className="p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, addressLine1: e.target.value }))}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, addressLine2: e.target.value }))}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, zipCode: e.target.value }))}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, insuranceId: e.target.value }))}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, primaryCondition: e.target.value }))}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, lastVisit: e.target.value }))}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setNewPatient((s) => ({ ...s, nextAppointment: e.target.value }))}
                      />
                    </div>
                  </div>
              ...
              <div className="flex justify-end space-x-3 pt-6">
                <button type="button" onClick={() => setShowAddPatient(false)} className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg">Cancel</button>
                <button type="submit" className="px-6 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700">Add Patient</button>
              </div>
            </form>
          </div>
        </div>
...
const AllReportsPage: React.FC = () => {
  const { reports, patients, loading, fetchReports, fetchPatients, updateReport } = useDoctor();
...
const handleEditFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const startEdit = (r: any) => {
    setEditData({
      ...
      medicationsPrescribed: r.medicationsPrescribed || "",
  ...
  const saveEdit = async (e: React.FormEvent) => {
    ...
    await updateReport(editData._id, {
      reportType: editData.reportType,
      primaryDiagnosis: editData.primaryDiagnosis,
      medicationsPrescribed: editData.medicationsPrescribed,
  ...
  const patientIndex = useMemo(() => {
    ...
    (patients || []).forEach((p) => p._id && m.set(String(p._id), p));
    return m;
  }, [patients]);
  ...
  const viewReport = (r: any) => {
    const pidObj = typeof r?.patientId === "object" ? r.patientId : undefined;
    const pid = pidObj ? pidObj._id || pidObj.id || pidObj.value : r?.patientId;
    const p = pid ? patientIndex.get(String(pid)) : undefined;
    const statusText = String(r?.status ?? "submitted");
    const followUp = r?.followUpDate ? fmt(r.followUpDate) : "—";
      ...
      <div style="text-align:left; line-height:1.6">
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px;">
          <div>
            ...
            ${
              p
                ? `<div><b>Name:</b> ${display(p.fullName)}</div><div><b>Phone:</b> ${display(p.phone)}</div><div><b>Condition:</b> ${display(p.primaryCondition)}</div>`
                : pidObj
                ? `<div><b>Phone:</b> ${display(pidObj.phone)}</div><div><b>Email:</b> ${display(pidObj.email)}</div>`
              ...
              <table className="min-w-full border border-gray-200 rounded-lg">
                ...
                <tbody>
                  {filtered.map((r: any) => {
                    ...
                    const condition = r.primaryDiagnosis || "—";

                    return (
                      <tr key={r._id} className="text-sm hover:bg-gray-50">
                        <td className="px-4 py-3 border-b">
                          <div className="font-medium text-gray-900">{r.reportType}</div>
                          <div className="text-gray-500">#{r._id}</div>
                        </td>

                        <td className="px-4 py-3 border-b">
                          <div className="font-medium text-gray-900">{name}</div>
                          <div className="text-gray-500">ID: {pid}</div>
                        </td>

                        <td className="px-4 py-3 border-b">{phone}</td>

                        <td className="px-4 py-3 border-b">{condition}</td>
                        ...
                        <td className="px-4 py-3 border-b">
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => window.alert(`Downloading report ${r._id}...`)}
...
{showEdit && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <form onSubmit={saveEdit} className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full p-3 border rounded-lg"
                  value={editData.medicationsPrescribed}
                  onChange={(e) =>
                    setEditData({ ...editData, medicationsPrescribed: e.target.value })
                  }
                />
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditData({ ...editData, primaryDiagnosis: e.target.value })
                  }
                />
              </div>

              <div>
                <label className="block text-sm font-medium mb-1">Lab Results</label>
                <textarea
                  rows={4}
                  className="w-full p-3 border rounded-lg"
                  value={editData.labResults}
                  onChange={(e) =>
                    setEditData({ ...editData, labResults: e.target.value })
                  }
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditData({ ...editData, recommendations: e.target.value })
                  }
                />
              </div>
            </div>
          ...
          <div className="space-y-3">
            <label className="block text-sm font-medium text-gray-700">
              Upload Attachments (PDF / Images / Docs)
            </label>
            ...
            {editAttachments.length > 0 && (
              <div className="bg-gray-50 border rounded-lg p-3 space-y-1 text-sm">
                <div className="font-medium text-gray-700 mb-1">Existing Files:</div>
          ...
          {/* FOOTER BUTTONS — STAYS FIXED BOTTOM */}
  ...
  const payload = {
    ...
    treatmentProvided: [
      ...
      formData.followUpDate
        ? `Follow-up Date: ${formData.followUpDate}`
        : "",
    ]
      .filter(Boolean)
      .join("\n"),
    medicationsPrescribed: formData.medications,
  ...
  <div className="grid md:grid-cols-2 gap-6">
    <div>
      ...
      <p className="text-xs text-gray-500 mt-1">
        The value saved will be the Patient ID. Names are for
        identification only.
      </p>
    </div>
